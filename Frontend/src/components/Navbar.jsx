    ...
    <>
      ...
      <nav className="flex relative z-100  items-center p-5 justify-between">
        <div className="flex items-center gap-4">
          ...
          >
            <div
              className={`line w-[20px] h-[2px] bg-black transition-transform duration-300 ${
                show ? "rotate-45 translate-y-[6px]" : ""
              }`}
            ></div>
            <div
              className={`line w-[20px] h-[2px] bg-black transition-opacity duration-300 ${
                show ? "opacity-0" : ""
              }`}
            ></div>
            <div
        ...
        <div className="flex gap-4">
          <button className="bg-transparent hidden lg:block">Log in</button>
          {show ? (
